...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 25, 2018 at 02:36 PM
...
CREATE TABLE `products` (
  ...
  `Product Description` varchar(500) NOT NULL,
...
('Cardigan ', '2', 650, 'Front Opening\r\nHood Neck\r\nFull Sleeve\r\nSoft Touch Cotton Fabric \r\nHand Wash', 'assets/products/men/shrugBlue.jpg', 1),
('V-Neck T-Shirt', '2', 350, '80% Cotton and 20% polyester\r\nV-Neck T-Shirt\r\nSlim Fit\r\nHalf Sleeve \r\nMachine Wash \r\nMade In India', 'assets/products/men/vneckBlack.jpg', 2),
('V-Neck T-Shirt', '2', 350, '80% Cotton and 20% polyester\r\nRound Neck \r\nSlim Fit\r\nHalf Sleeve \r\nMachine Wash \r\nMade In India', 'assets/products/men/vneckWhite.jpg', 3),
('Round Neck T-Shirt', '2', 350, 'Round Neck T-Shirt', 'assets/products/men/roundneckBlack.jpg', 4),
('Round Neck T-Shirt', '2', 350, '80% Cotton and 20% polyester Round Neck Slim Fit Half Sleeve Machine Wash Made In India', 'assets/products/men/roundneckBlue.jpg', 5),
('Collar T-Shirt', '2', 500, '60% Cotton and 40% polyester Collar Neck Slim Fit Half Sleeve Machine Wash Made In India', 'assets/products/men/collarblack.jpg', 6),
('Collar T-Shirt', '2', 500, '60% Cotton and 40% polyester Collar Neck Slim Fit Half Sleeve Machine Wash Made In India', 'assets/products/men/collarBlue.jpg', 7),
('Half Sleeve Shirt', '2', 500, '80% Cotton and 20% polyester \r\nRegular Fit \r\nHalf Sleeve \r\nMachine Wash \r\nMade In India', 'assets/products/men/halfsleeveshirtGreen.jpg', 8),
('Half Sleeve Shirt', '2', 500, '80% Cotton and 20% polyester \r\nRegular Fit \r\nHalf Sleeve \r\nMachine Wash \r\nMade In India', 'assets/products/men/halfsleeveshirtWhite.jpg', 9),
('Full Sleeve Shirt', '2', 650, '80% Cotton and 20% polyester\r\nSlim Fit \r\nFull Sleeve \r\nMachine Wash \r\nMade In India', 'assets/products/men/fullsleeveBlue.jpg', 10),
('Full Sleeve Shirt', '2', 650, '80% Cotton and 20% polyester\r\nSlim Fit \r\nFull Sleeve \r\nMachine Wash \r\nMade In India', 'assets/products/men/fullsleeveRed.jpg', 11),
('Joggers Tracks', '2', 700, '97% cotton and 3% elastane\r\nSlim Fit\r\nCold Water Machine Wash\r\nMade in India', 'assets/products/men/joggertracksBlack.jpg', 12),
('Joggers Tracks', '2', 700, '97% cotton and 3% elastane\r\nSlim Fit\r\nCold Water Machine Wash\r\nMade in India', 'assets/products/men/joggertracksGrey.jpg', 13),
('Jogger Jeans', '2', 800, 'Material:- Denim Jeans\r\nSlim Fit\r\nCold Water Machine Wash\r\nMade in India', 'assets/products/men/joggerjeansBlack.jpg', 14),
('Jogger Jeans', '2', 800, 'Material:- Denim Jeans\r\nSlim Fit\r\nCold Water Machine Wash\r\nMade in India', 'assets/products/men/joggerjeansBlue.jpg', 15),
('Jeans', '2', 1000, '\r\nDenim Jeans\r\nSlim Fit\r\nCold Water Machine Wash\r\nMade in India', 'assets/products/men/jeansBlack.jpg', 16),
('Jeans', '2', 1000, '\r\nDenim Jeans\r\nSlim Fit\r\nCold Water Machine Wash\r\nMade in India', 'assets/products/men/jeansBlue.jpg', 17),
('Shorts', '2', 450, '100% combed Cotton\r\nBillabong Shorts\r\nMachine Wash\r\nMade In India', 'assets/products/men/shortsBlack.jpg', 18),
('Shorts', '2', 450, '100% combed Cotton\r\nBillabong Shorts\r\nMachine Wash\r\nMade In India', 'assets/products/men/shortsCargo.jpg', 19),
...
INSERT INTO `shipping_details` (`Email`, `Title`, `Name`, `Address`, `PinCode`, `Phone`, `Mobile`) VALUES
('anc@yoin.in', 'sd', '', '', '35454', '6546156', '56465456156'),
('nachiketbhuta@gmail.com', 'df', 'dfg gf df', 'gf gf', '54151', '654654', '5402302302');
...
('yo', 'e10adc3949ba59abbe56e057f20f883e', 'yo@yo.in');
